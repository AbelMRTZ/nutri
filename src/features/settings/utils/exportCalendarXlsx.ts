 ...
 * range). Web-only (see AjustesScreen/CalendarExportSection) — dynamically
 * imports the browser build of write-excel-file so the module is never
 * pulled into the native bundle's evaluated code path.
 */
