...
/** Header-right "add" and "help" actions for the Ejercicios list screen. */
export function EjerciciosHeaderActions() {
  ...
  return (
    <View style={styles.row}>
      ...
      <Pressable
        ...
        hitSlop={10}
        onPress={() => router.push('/(app)/(tabs)/entrenamiento/ejercicios/nuevo')}>
